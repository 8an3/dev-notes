...
- [ ] last stable version 351
- [ ] add global settings file opener in quick pick
- [ ] need to add md pre-processor to readme
- [ ] convert node .js scripts over to extension functions allowing other workspaces the same functionality
